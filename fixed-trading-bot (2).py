...
DEFAULT_WEBHOOK_URL = 'https://api.primeautomation.ai/webhook/ChartPrime/3b5d0beb-ed61-437c-9d1e-116b0047273d'

# Default webhook mappings in case config file doesn't exist
DEFAULT_WEBHOOK_URLS = {
    'BTC/USDT': 'https://api.primeautomation.ai/webhook/ChartPrime/3b5d0beb-ed61-437c-9d1e-116b0047273d',
    'SOL/USDT': 'https://api.primeautomation.ai/webhook/ChartPrime/0106285e-b00f-44f9-b811-f80c2d3a17d4',
    'default': 'https://api.primeautomation.ai/webhook/ChartPrime/3b5d0beb-ed61-437c-9d1e-116b0047273d'
}
...
def main():
    ...
    logging.info("Starting enhanced trading bot with multi-timeframe analysis and trend detection")
